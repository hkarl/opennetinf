...
-- Create user
--
GRANT USAGE ON *.* TO 'sdbuser'@'%'; -- workaround since DROP USER IF EXISTS is not supported by mysql
DROP USER 'sdbuser'@'%';
CREATE USER 'sdbuser'@'%' IDENTIFIED BY 'sdbpass';
GRANT ALL ON *.* TO 'sdbuser'@'%';

--
-- Current Database: `netinf_node_data`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `netinf_node_data` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `Quads` (
  ...
  PRIMARY KEY (`g`,`s`,`p`,`o`),
  KEY `ObjSubjGra` (`o`,`s`,`g`),
  KEY `PredObjGra` (`p`,`o`,`g`),
  KEY `GraSubjPred` (`g`,`s`,`p`),

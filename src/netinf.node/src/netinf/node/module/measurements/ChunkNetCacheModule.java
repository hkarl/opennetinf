 ...
 */
public class ChunkNetCacheModule extends AbstractNodeModule {

   public static final String NODE_PROPERTIES = "../configs/veclientconfigs/nconly/chunknetcache.properties";

   public ChunkNetCacheModule() {

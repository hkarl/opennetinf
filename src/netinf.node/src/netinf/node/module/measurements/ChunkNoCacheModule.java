 ...
 */
public class ChunkNoCacheModule extends AbstractNodeModule {

   public static final String NODE_PROPERTIES = "../configs/veclientconfigs/cachingoff/chunknocache.properties";

   public ChunkNoCacheModule() {
   ...
   /*
    * @Singleton
    * @Provides BOCacheServer[] provideBOCaches(NetworkCache nw ,PeersideCache ps) { return new BOCacheServer[] { ps, nw }; }
    */

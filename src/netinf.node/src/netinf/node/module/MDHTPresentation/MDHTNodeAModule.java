 ...
 */
public class MDHTNodeAModule extends AbstractNodeModule {

   public static final String NODE_PROPERTIES = "../configs/MDHT-Presentation/NodeA.properties";

   public MDHTNodeAModule() {

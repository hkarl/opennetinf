...
public class PeerSideCacheModule extends PrivateModule {
   ...
   protected void configure() {
      bind(PeerSideCache.class).to(PeerSideCacheImpl.class).in(Singleton.class);
      bind(PeerSideCacheServer.class).to(PeerSideCacheServerImpl.class).in(Singleton.class);

...
public class FreePastryDHT implements DHT, Application {
         ...
         if (false == msgUnpacked.isGetRequest) {
            ...
            app.insert(myContent, new Continuation() {
               ...
               public void receiveResult(Object result) {
                  ...
                  LOG.info(myContent + " successfully stored at " + numSuccessfulStores + " locations.");
               }
               ...
               app.fetch(lookupKey, new Continuation<PastContent, Exception>() {
                  public void receiveResult(PastContent result) {
                     ...
                     if (result instanceof DummyPastContent) {
                        ...
                        NetInfDHTMessage replyMsg = new NetInfDHTMessage(endpoint.getLocalNodeHandle().getId(),
                              msgUnpacked.requester.getId(), result);
   ...
   public boolean forward(RouteMessage msgToForward) {
      try {
         ...
         LOG.error("Exception thrown: " + ioe.getMessage()
               + ". Could not get a deserializer for the NetInfDHTMessage, aborted operation.");
      }
    ...
    * 
    * @param destId
    *           The node Id of the message destination
    */
    ...
    *           The NodeHandle object of the destination node
    */

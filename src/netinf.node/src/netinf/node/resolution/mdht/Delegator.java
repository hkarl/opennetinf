...
public class Delegator {
    ...
    * @return non-null EventDelegate. Returned delegate will be a dynamic proxy implementing that interface
    * More info about proxies: http://www.webreference.com/internet/reflection/3.html  
    */ 
  public EventDelegate build(Object target, String methodName)
  {
      ...
      EventDelegate ret  = (EventDelegate)java.lang.reflect.Proxy.newProxyInstance(

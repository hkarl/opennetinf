...
public class DefinedQueryTemplatesTest {
	...
	public void testSearch(){
		...
		assertEquals("positionBasedShopInRadiusHasProduct",DefinedQueryTemplates.getDefinedQueryTemplateName("positionBasedShopInRadiusHasProduct").getQueryTemplateName());

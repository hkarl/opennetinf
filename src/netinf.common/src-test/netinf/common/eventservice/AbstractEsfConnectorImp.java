...
@Override
public void setInitialSubscriptionInformation(
		List<String> subscriptionIdentifications,
		List<String> subscriptionQueries, List<Long> subscriptionExpireTimes) {
	// TODO Auto-generated method stub
	super.setInitialSubscriptionInformation(subscriptionIdentifications,
			subscriptionQueries, subscriptionExpireTimes);
}

@Override
public void sendSubscription(String subscriptionIdentification,
		String subscriptionQuery, long subscriptionExpires) {
	// TODO Auto-generated method stub
	super.sendSubscription(subscriptionIdentification, subscriptionQuery,
			subscriptionExpires);
}
